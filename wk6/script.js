...
var newestSpeech=speechesArray[0].year;
...
} else if(speechesArray[0].year>=newestSpeech) {
  console.log('This is the most recent speech on the page.');
} else {
  console.log('This is neither the newest nor oldest speech on the page.');
}
});
...
if(speechesArray[1].year<=oldestSpeech) {
  console.log('This is the oldest speech on the page.')
} else if(speechesArray[1].year>=newestSpeech) {
  console.log('This is the most recent speech on the page.');
} else {
  console.log('This is neither the newest nor oldest speech on the page.');
}
...
if(speechesArray[2].year<=oldestSpeech) {
  console.log('This is the oldest speech on the page.')
} else if(speechesArray[2].year>=newestSpeech) {
  console.log('This is the most recent speech on the page.');
} else {
  console.log('This is neither the newest nor oldest speech on the page.');
}
